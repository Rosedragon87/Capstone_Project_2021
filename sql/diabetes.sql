...
CREATE TABLE health_indicators_nonpre AS (SELECT highbp, highchol, bmi, stroke, heartdiseaseorattack, diffwalk from nondiabetes_and_diabetes_health_indicators);
